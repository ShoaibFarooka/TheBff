  ...
  return (
    <div>
      <div className="h pb-28 flex justify-around flex-col lg:flex-row px-[20px] lg:px-[100px] lg:pt-[50px] ">
            ...
            >
              {classes?.map((c?: any, index?: any) => (
                <SwiperSlide key={index} className="w-full">
                  <Image
                    key={index}
                    className={`w-full lg:w-6/12 lg:mx-auto hover:shadow-white/60 hover:shadow-lg hover:scale-110 duration-300 rounded-md ${
        ...
        <div className="w-full lg:w-1/2 content h-full ">
