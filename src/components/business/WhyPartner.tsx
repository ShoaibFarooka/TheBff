    ...
    <div>
         <div className="md:px-36 py-20 grid grid-cols-1 md:grid-cols-3 gap-28">
            {partnerWithUs.map((c? :any, index? :any) => (
                <div key={index} className='hover:shadow-[0px_0px_5px_4px_rgb(0,0,0,0.3)] hover:duration-300 cursor-pointer hover:shadow-gray-500 p-2'>
                   ...
                   {c.title}
                    ...
                    <p className="text-[#C2C2C2] text-center">
                    {c.description}
                    </p>
              </div>
