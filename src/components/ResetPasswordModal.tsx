  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button tabIndex={1} className="hover:underline cursor-pointer text-gray-300 p-0 bg-transparent"> Forgot password? Reset </button>
      </DialogTrigger>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <DialogFooter>
            <DialogTrigger asChild>
                <Button variant={'destructive'} ref={ref}> Cancel </Button>
            </DialogTrigger>
            <Button onClick={handleSubmit} disabled={loading} className="bg-purple-600 hover:bg-purple-500 flex gap-3 mb-2">
                {
                    loading ? <>
                        <span> Loading </span>
