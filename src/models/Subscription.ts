...
const SubscriptionSchema = new Schema<SubscriptionDoc>(
    {
        _id: { type: mongoose.Types.ObjectId, auto: true, required: true, get: (v: mongoose.Types.ObjectId) => v.toString() },
...
const Subscription = models.Subscription || mongoose.model<SubscriptionDoc>('Subscription', SubscriptionSchema);
