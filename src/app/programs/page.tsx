  ...
  return (
    <>
      ...
      <div className="my-20 relative">
          ...
          <div className="w-full mt-10">
            ...
            <div className="w-full grid grid-cols-3 text-white/90 md:text-xl px-4 md:px-0">
              ...
              <div className="col-span-1 py-3 border border-gray-400/40 center flex-col">
                ...
                <button onClick={toggleOverlay} className="shadow-xl shadow-red-800/10 mx-auto rounded px-2 py-1.5 border-none outline-none bg-white text-red-500 font-semibold focus:border"> View Plans </button>
              </div>
              <div className="col-span-1 py-3 border border-gray-400/40 center flex-col">
        ...
        {overlayVisible && 
        <div className="absolute top-0 left-0 w-full h-full  flex justify-center   z-50 bg-opacity-70 backdrop-blur">
          ...
          <button
          onClick={onClose}
          className="absolute top-2 left-2 bg-white rounded-2xl"
        >
          <Image src={cross}  alt=""/>
        </button>
          ...
          <div className="w-full   mx-auto mb-4 ">
            <p className="text-white text-center">Gorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus.</p>
          </div>
          <div className="flex justify-center items-center ">
            <div className="inline bg-white px-1 py-1 rounded-md">
            <button className="px-4 py-2 hover:bg-blue-300 hover:text-white rounded-md"> 1 month </button>
            <button className="px-4 py-2 hover:bg-blue-300 hover:text-white rounded-md">3 month </button>
            <button className="px-4 py-2 hover:bg-blue-300 hover:text-white rounded-md" >6 month</button>
          ...
          <div className="flex justify-center items-center py-12 ">
            ...
            <div className="bg-[#E7E7FF] py-10 px-10 rounded-lg mx-5">
              <h2 className="font-[600] text-2xl text-center">Standard</h2>
              ...
              <div className="mt-10"> 
                ...
                <button className="px-3 py-1 rounded-lg  text-white bg-[#6557FF]">Buy Now</button>
            ...
            <div className="bg-[#FFCC61] py-[70px] px-10 rounded-lg mx-5">
              <div className="text-center">
                <button className="text-white bg-[#6557FF] px-1 rounded-md">-30%</button>
              </div>
              <h2 className="font-[600] text-2xl  text-center">Premium</h2>
            ...
            <div className="bg-[#E7E7FF] py-10 px-10 rounded-lg mx-5">
              <h2 className="font-[600] text-2xl  text-center">Enterprise</h2>
