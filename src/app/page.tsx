  ...
  return (
    <>
      ...
      <div className='relative min-h-[90vh] bg-opacity-20'>
        ...
        <video controls={false} autoPlay loop muted className="w-full h-screen object-cover aboslute top-0 left-0"  >
      ...
      {/* ===========================Types of Programs===================== */}
        ...
        <div className='h-screen lg:flex justify-around px-[20px] lg:px-[100px] lg:pt-[50px]'>
          ...
          <div className='h-full lg:h-[75%] overflow-y-scroll no-scrollbar mt-[100px]  md:pl-[100px] '>
            <Image className=' w-full md:w-[90%]  my-4 hover:shadow-white hover:shadow-lg hover:scale-110 duration-300' src={div} alt='Weight Management' />
            <Image className=' w-full md:w-[90%]  my-4 hover:shadow-white hover:shadow-lg hover:scale-110 duration-300' src={div1} alt='Weight Management' />
            <Image className=' w-full md:w-[90%]  my-4 hover:shadow-white hover:shadow-lg hover:scale-110 duration-300' src={div} alt='Weight Management' />
            <Image className=' w-full md:w-[90%]  my-4 hover:shadow-white hover:shadow-lg hover:scale-110 duration-300' src={div1} alt='Weight Management' />
            <Image className=' w-full md:w-[90%]  my-4 hover:shadow-white hover:shadow-lg hover:scale-110 duration-300' src={div} alt='Weight Management' />
          ...
          <div className='lg:w-[45%]'>
              <div className='w-full'>
                  <div className='text-[#AFCCF8] text-center text-[24px] md:text-[40px] font-bold'>Workout Program</div>
          
                  <div className='text-center text-[24px] md:text-[40px] font-bold text-[#FED25B]'>made for you</div>
              </div>
              <div className="rounded-3xl bg-gradient-to-r from-[#4A2F70] to-[#344363] px-[25px] py-5  lg:px-[55px] lg:py-10">
                <h1 className='text-center font-bold text-[24px] md:text-[30px] text-[#FED25B]'>Weight Management</h1>
      ...
      <div  className='h-screen sm:px-[100px] sm:py-[60px] px-[40px] py-[20px]'>
        <div className='text-2xl sm:text-[50px]  '>
            ...
            Reax your body nd mind

            </p>
            <p  className = 'text-[#F2BD4D]  font-[600] text-center sm:mb-12 '>With your yoga coaches</p>
        </div>
       
       <div className='overflow-x-auto  whitespace-nowrap'>
       <div className='slide-track     space-x-[200px] w-full mt-6 '>
            
            <div className=' inline-block  flex-shrink-0 text-white '>
                <Image className=' h-[431px]    object-cover   hover:scale-105 duration-300' src={coach1} alt="/" />
           ...
           <div className=' inline-block  flex-shrink-0  text-white  '>
                <Image className='h-[431px]    object-cover  hover:scale-105 duration-300 mb-3' src={coach2} alt="/" />
            ...
            <div className='  inline-block  flex-shrink-0  text-white  '>
                <Image className=' h-[431px]    object-cover  hover:scale-105 duration-300' src={coach3} alt="/" />
            ...
            <div className='  inline-block  flex-shrink-0 text-white '>
                <Image className=' h-[431px]  object-cover  hover:scale-105 duration-300' src={coach2}  alt="/" />
