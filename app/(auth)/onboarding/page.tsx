    ...
    return (
        <div className="min-h-[70vh] center flex-col mt-24 text-white">
            ...
            <div className="max-w-2xl center flex-col">
                ...
                <h2 className="text-5xl text-center mb-12 font-semibold">
                    Welcome !
                </h2>
                ...
                {
                    email && <h2 className="text-2xl flex text-center">
                        An <FiMail size={25} className="text-blue-500 ml-2 mr-1 mt-1" /> email with the verification link has been sent to you. 
                    </h2>
                }
                {/* {
                ...
                <p className="text-red-400 mt-6 text-lg">
                    You won&#39;t be able to use your account until you verify your email address.
                </p>

                <div className="center gap-5">
                    {
                        showResendEmail && <Button onClick={() => handleResend('e')} disabled={loading} className="mt-7 center gap-3 disabled:cursor-not-allowed" variant={'secondary'}>
