...
export const POST = async (req: NextRequest) => {
    ...
    try {
        ...
        const { name, email, phone, password, signup, cb } = body;
        ...
        return handelSignup(name, email, phone, password);
...
async function handelSignup (name: string, email: string, phone: string, password: string) {
